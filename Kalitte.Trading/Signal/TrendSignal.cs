...
namespace Kalitte.Trading
{
    ...
    public class TrendResult
    {
        ...
        public override string ToString()
        {
            if (Reference == null)
            {
                ...
                return $"date: {Date}, dir: {Direction} nv:{NewValue} ov: {OldValue} ref:[{Reference.Date}, {Reference.Direction}, {Reference.Change}]";
    ...
    public class TrendSignal : Signal
    {
        ...
        {
            //Log($"{DateTime.Now} received bar change. Last is {this.i1k.InputBars.Last}", LogLevel.Critical);
            generateDerivs();
        }
        ...
        protected override SignalResultX CheckInternal(DateTime? t = null)
        {
            ...
            if (priceBars.IsFull && mp >= 0)
            {
                ...
                if (analysisBars.Count >= Periods && BarTrendResults.Count > 0)
                {
                    ...
                    result.Trend = getTrendDirection(currentVal, lastBarData, BarTrendResults.LastOrDefault());
