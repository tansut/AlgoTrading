...
{
	public class testws : MatriksAlgo
	{
		...
		{
			connection = new HubConnection("http://localhost:50968");
			
				connection.Headers.Add("headername", "headervalue");
				stockTickerHubProxy = connection.CreateHubProxy("chathub");
				stockTickerHubProxy.On<string, decimal>("stockpriceupdate", (symbol, price) =>
				{
					Debug("message: " + symbol + "-" + price);
				});
				...
				stockTickerHubProxy.Invoke<object>("updateprice", "xxxx", 123);
		...
		public override void OnDataUpdate(BarDataCurrentValues barDataCurrentValues)
		{
			...
			stockTickerHubProxy.Invoke<object>("updateprice", Symbol, barDataCurrentValues.LastUpdate.Close);
